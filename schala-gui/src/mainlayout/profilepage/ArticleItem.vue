<template>
    <q-item clickable @click="goToArticle">
        <q-item-section>
            <q-item-label>{{ props.article.title }}</q-item-label>
            <q-item-label caption lines="2">Published at {{ props.article.venue }}</q-item-label>
        </q-item-section>
