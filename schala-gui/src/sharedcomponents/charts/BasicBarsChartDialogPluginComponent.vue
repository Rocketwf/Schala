<template>
  ...
  >
    <q-card class="q-dialog-plugin">
      ...
      -->
      <popup-button
        v-for="popupBtn in basicBarsChartModel.popupButtons"
        :key="popupBtn.id"
        :popup-button-model="popupBtn"
      />
      <basic-bars-chart :basic-bars-chart-model="basicBarsChartModel" />
...
import BasicBarsChart from './BasicBarsChart.vue';
