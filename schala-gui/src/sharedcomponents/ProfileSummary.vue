<template>
    ...
    <q-item-section side>
      <q-avatar square style="width: 145px; height: 180px">
        <img src="https://scholar.googleusercontent.com/citations?view_op=view_photo&user=23RPQBQAAAAJ&citpid=2" />
      </q-avatar>
      <q-item-label class="full-width self-center">
        <q-btn @click = "handleActionButton"
          unelevated
          label="Compare"
...
import { FullProfile } from "../../../core/models/profile/Profile";
