...
import StackedColumns100ChartCard from '../../../../sharedcomponents/cards/graphchartcards/StackedColumns100ChartCard.vue';
...
const mockCardModel = new StackedColumns100ChartModel('Title', '', ViewName.StackedColumns100ChartCard, 10, series, 'x-title', 'y-title', labels);
