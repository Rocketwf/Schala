...
module.exports = {
    ...
    coveragePathIgnorePatterns: [
        '/node_modules/',
        '.d.ts$',
        '/src/mainlayout/searchresultspage/SearchResultsPage.vue',
        '/src/mainlayout/profilepage/ProfilePage.vue',
        '/src/mainlayout/comparepage/ComparePage.vue',
    ],
    coverageThreshold: {
        global: {
            //  branches: 50,
