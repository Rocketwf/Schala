...
describe('ExpertiseModel tests', () => 
{
    ...
    {
        const testExpertise: Expertise[] = [new Expertise('Computer Science', [new ProfileExpertise('Computer Science', 5)])];
    ...
    {
        const testView: ViewName = ViewName.ExpertiseCard;
...
describe('Expertise tests', () => 
{
    ...
    it('sets and returns correct expertise', () => 
    {
        const testProfileExpertise: ProfileExpertise[] = [new ProfileExpertise('Computer Science', 10)];
