...
/**
 * Data structure for the basic columns chart.
 */
export class BasicColumnsChartModel extends ObjectSeriesChartModel implements SimpleCardModel 
{
    /**
     ...
     * @returns the created copy as BasicColumnsChartModel
     */
    deepCopy(): BasicColumnsChartModel 
    {
        ...
        return new BasicColumnsChartModel(
            this.title,
            this.sub,
            this.viewName,
            this.colWidth,
