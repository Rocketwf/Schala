...
/**
 * Data structure for the distributed columns chart.
 */
export class DistributedColumnsChartModel extends ObjectSeriesChartModel implements SimpleCardModel 
{
    /**
     ...
     * @returns the created copy as DistributedColumnsChartModel
     */
    deepCopy(): DistributedColumnsChartModel 
    {
