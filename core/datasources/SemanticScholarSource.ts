...
export default class SemanticScholarSource implements DataSource {
  ...
  private constructor() {
    ...
    let promise : Promise<GetUsersResponse> = this.getUsers("walter tichy");
